(function(){
	...
	jsel.innerHTML = 'bhelpSrvAddress="'+bhelpSrvAddress+'",bhelpSrvId='+bhelpSrvId+',bhelpInfoAddress="'+bhelpInfoAddress+'",ba=bhelpSrvAddress+"/main.js?'+bhelpVer+'",bhelpSrvVersion='+bhelpSrvVersion+',bhelpVer='+bhelpVer+',bl="bhelp_latest";'+html;
